...
#define MACHINE_UUID "d6a0becf-4f8f-4e99-82c6-9051ad51cc40"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define DEFAULT_bedKp 33.59
    #define DEFAULT_bedKi 6.67
    #define DEFAULT_bedKd 112.80
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 314.4 }
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (8*80) }
